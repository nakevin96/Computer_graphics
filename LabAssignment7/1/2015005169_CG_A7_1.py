...
ambient_diffuse_ObjectColor = (1., 1., 1., 1.)
...
def render():
    global gCamAng, gCamHeight, diffuseLightColor, specularLightColor, ambient_diffuse_ObjectColor
    ...
    glMaterialfv(GL_FRONT, GL_DIFFUSE, ambient_diffuse_ObjectColor)
    glMaterialfv(GL_FRONT, GL_AMBIENT, ambient_diffuse_ObjectColor)
...
def key_callback(window, key, scancode, action, mods):
    ...
    if action==glfw.PRESS or action==glfw.REPEAT:
        if key==glfw.KEY_1:
            ...
            ambient_diffuse_ObjectColor = (1., 0., 0., 1.)
        elif key == glfw.KEY_X:
            ambient_diffuse_ObjectColor = (0., 1., 0., 1.)
        elif key == glfw.KEY_C:
            ambient_diffuse_ObjectColor = (0., 0., 1., 1.)
        elif key == glfw.KEY_V:
            ambient_diffuse_ObjectColor = (1., 1., 1., 1.)
